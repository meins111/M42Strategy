...
\section{Armies}
An army is a collection of units, lead by a commander. Given the nature of warfare in the grim-dark future, an army is (usually) accompanied by fleet elements, providing inter- and intra-system transport, protection and supply storage for the units making up the army.

\section{Commanders}
A commander is an accomplished leader of a faction, put in command of an army. The faction leader of each faction is the overall commander and usually the commander of the main army. Secondary Commanders can be assigned to new armies as necessary. Commanders can gain traits and followers (advisors, bodyguards, ...) during their career.

\section{Heroes}
Heroes are singular entities, renowned throughout their factions and beyond. Heroes can move around on their own - they do not need a commander or large fleet, a single small warp-capable ship is suffice.
Heroes can be linked to an army, providing a morale boost to all units therein. 
Whether or not they are linked to an army, heroes have different skills (some active some passive) they can use to influence the world around them.
...
\begin{itemize}
	...
	\item \textbf{Produce:} This activity represents the expenditure of resources to produce something (usually supplies, a unit or planetary advancement).
	\begin{itemize}
