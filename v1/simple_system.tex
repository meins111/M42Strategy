...
\subsection{Adeptus Astartes Heroes}
\begin{itemize}
    ...
    \begin{itemize}
        \item Special Action [Preach]: Greatly improves loyalty and morale of local population or targeted allied unit. The lower its morale or loyalty was, the greater the boost it will receive.
        \item Special Action [Purge]: Reduce HP of an allied unit with the "Corrupted" or "Infected" trait to remove the effect. HP reduction depends on the severity of the respective effect.
        \item Passive Effect: 20\% Morale boost for all allied units on the same battlefield.
        \item Passive Effect: 20\% Morale penalty for enemy units subject to fear.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Special Action [Holocaust]: Unleashes a massively powerful psychic firestorm against an enemy unit. Induces direct HP damage to the selected target. Increased damage against units with the [Psyker], [Demonic], [Mutant] or [Tyrannid] trait. Deals additional morale damage to other enemy units on the same battleground.
    ...
    \begin{itemize}
        \item Special Action [Cure]: Attempts to cure one of father Nurgle's many 'gifts' from a target unit or population, restoring HP and Morale if successful.
        \item Special Action [Screen]: Increase the chance of the local planet to produce one unit of Neophytes. Increased chance to detect genestealer cults.
        \item Passive Effect: Slightly reduces the HP damage allied units within the same battlefield take from combat.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Dreadnought / Assembly / Chapter Hold or Fleet / 1 / Dreadnought Chassis
        \end{itemize}
        \item Special Action [Artificer Wargear]: Being even less dependent on sleep than his brethren, a Tech-Marine spends any free time on the anvil to produce armor and arms of exceptional quality. In addition to Astartes wargear (see: \ref{production_table_units}) a Tech-Marine can also create Terminator armor and dreadnought chassis given enough time and resources. This action triggers one of the following production processes, whenever his Battlegroup is in the Production stance.
        \begin{itemize}
            \item Dreadnought Chassis / Part / Chapter Hold or Fleet / 16 
            \item Suit of Terminator Armor / Part / Chapter Hold or Fleet
        \end{itemize}
        ...
        \item Special Action [Jam]: The Tech-Marine attempts to jam the communication equipment of an enemy Battle Group, reducing the CE of all its units for one round. Ambush, Shock and surprise assaults on a jammed macro unit inflict additional HP and Morale damage.
        \item Passive Effect: Attached Astartes units may recover in the field regardless of their remaining HP, as the Tech-Marine is keeping their equipment in working condition.
        \item Passive effect: Attached Astartes armored units recover 5\% HP in the field, as long as they have more than 50\% HP left.
    \end{itemize}
\end{itemize}
