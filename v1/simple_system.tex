...
\section{Armies}
An army is a collection of units, lead by a commander. Given the nature of warfare in the grim-dark future, an army is (usually) accompanied by fleet elements, providing inter- and intra-system transport, protection and supply storage for the units of the army.

\section{Commanders}
A commander is an accomplished leader of a faction, put in command of an army. The faction leader of each faction is the overall commander and usually the commander of the main army. Secondary Commanders can be assigned to new armies as necessary.
