...
\begin{itemize}
	...
	\item \textbf{Hit'n'Run:} This fast unit is able to hit an enemy hard and fast before quickly disengaging before reinforcement or heavy weapons can be broad to bear on them. Increases CE during the first round of a conflict or skirmishing by 25\% but reduced CE by 25\% during long-term engagements.
 	...
 	\item \textbf{Favored Enemy (X):} This unit has intense training and experience in fighting a certain enemy of mankind. Its morale increases by 30\% when facing units of that faction and any HP damage dealt is increase by 50\%. It will target units of that faction first in case of a multi-faction war-zone.
